    ...
    <div className="min-h-screen bg-orange-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 text-center">
          ...
          <p className="text-orange-700 mb-6 font-medium">
          ...
          {orderId && (
            <div className="bg-indigo-50 rounded-lg p-4 mb-6 border border-indigo-200">
              ...
              <p className="font-mono text-sm font-bold text-indigo-900">{orderId}</p>
            </div>
          )}
    ...
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-orange-50">
        <div className="text-center">
          ...
          <p className="mt-4 text-indigo-900 font-medium">Loading...</p>
        </div>
      </div>
    }>
